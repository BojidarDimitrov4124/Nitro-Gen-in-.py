...
class NitroGen:
    ...
    def main(self):
        ...
        if os.name == "nt":
            print("")
            ctypes.windll.kernel32.SetConsoleTitleW("Nitro Generator and Checker - Made by BD")

        else:
            print(f'\33]0;Nitro Generator and Checker - Made by BD\a', end='', flush=True)

        print("""\033[31;2;40m
BDimitrov4 Discord Fast Nitro
Fast Discord Nitro Generator V 1.0""")
        time.sleep(2)
        self.slowType("Made by BD", .02)
        time.sleep(1)
        ...
        for i in range(num):
            ...
            if os.name == "nt":
                ctypes.windll.kernel32.SetConsoleTitleW(f"Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid - Made by BD")
                print("")

            else:
                print(f'\33]0;Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid - Made by BD\a', end='', flush=True)
